...
import { TTL_UP_TO_DATE_MS, TTL_UPGRADE_MS, evaluateUpdateCheck, fetchLatestNpmVersion, isNewer, isThrottled, parseSemver, pendingNotice, } from "../lib/version-check.mjs";
