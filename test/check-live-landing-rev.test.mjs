...
import { APEX_URL, PAGES_DEV_URL, extractRev, waitForLiveRev, } from "../bin/check-live-landing-rev.mjs";
...
describe("check-live-landing-rev CLI", () => {
    it("exits 0 when the injected fetch already serves package.json's version", () => {
        ...
        try {
            ...
            writeFileSync(fake, "export default async () => '<span>REV 9.9.9</span>';\n");
