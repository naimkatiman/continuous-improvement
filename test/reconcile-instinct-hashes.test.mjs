...
describe("discoverGroups + applyGroup", () => {
    ...
    it("merges a C:/ alias into the canonical c:/ hash and is idempotent", () => {
        ...
        writeFileSync(join(aliasDir, "project.json"), `${JSON.stringify({ id: alias, name: "DrSaid-standup", root: "C:/Ai/DrSaid-standup", created_at: "2026-06-24T02:49:40Z" })}\n`);
        writeFileSync(join(aliasDir, "observations.jsonl"), '{"ts":"2026-06-24T02:49:40Z","tool":"Read","project_name":"DrSaid-standup"}\n{"ts":"2026-08-22T02:50:09Z","tool":"Edit","project_name":"DrSaid-standup"}\n');
        ...
        const destProject = JSON.parse(readFileSync(join(root, canonical, "project.json"), "utf8"));
        ...
        const aliasMarker = JSON.parse(readFileSync(join(aliasDir, "alias.json"), "utf8"));
