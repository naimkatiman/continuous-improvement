...
- **41 shipped PM skills in `skills/`** (27 phase skills across 6 phases, 8 foundation skills, 6 utility skills)
- **48 slash-command docs in `commands/`** (41 skill commands plus 7 workflow commands)
...
```
skills/            # All 41 skill definitions (27 phase + 8 foundation + 6 utility, flat)
