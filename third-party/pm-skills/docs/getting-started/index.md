...
Installs all 41 skills into your agent's default skills directory. Works with Claude Code, Cursor, GitHub Copilot, Cline, and any agent supported by the open [`skills` CLI](https://github.com/vercel-labs/skills). Shipped in v2.11.1 and now the recommended install path.
...
- **41 skills in `skills/`** covering the PM lifecycle (27 phase skills + 8 foundation skills + 6 utility skills)
...
The repo currently ships 48 command markdown files: 41 skill commands plus 7 workflow commands.
...
- Lists all 41 registered skills with paths and descriptions
- Provides workflows
