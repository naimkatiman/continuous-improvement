---
title: PM Skills
description: 41 AI agent skills for product managers - open-source, spec-compliant, and ready for Claude Code, Cursor, GitHub Copilot, and more.
tags:
  - Home
---
...
**41 best-practice product management skills for AI agents.**
...
| [Triple Diamond](workflows/triple-diamond.md) | Major initiatives | All 27 phase skills across 6 phases |
...
| **[v2.12.0](releases/Release_v2.12.0.md)** | 2026-05-03 | OKR Skills Launch: `foundation-okr-writer` + `measure-okr-grader` with canonical type and indicator-class enums; 38 to 41 skills |
