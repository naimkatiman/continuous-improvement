...
!!! warning "Generated file"
    This page is regenerated by `scripts/generate-skill-pages.py`. Edit the source at `skills/discover-market-sizing/SKILL.md` and re-run the generator.
...
??? example "Market Sizing: AI Coding Assistant for US SMB Developer Teams"
