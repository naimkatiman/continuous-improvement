...
| File | Purpose | When to read it |
|------|---------|-----------------|
| [`commands.md`](commands.md) | Complete table of every slash command shipped, mapped to its target skill or workflow and phase. 48 commands as of v2.12.0: 40 skill commands plus 7 workflow commands. | When the user asks "what commands exist?" or you need the canonical command-to-skill mapping. |
...
2026-05-03 with v2.12.0 OKR Skills Launch (count refresh: 48 commands, 41 skills).
