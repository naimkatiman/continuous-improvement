...
<h4 align=”center”>A curated collection of 41 best-practice, plug-and-play product management “agent skills” (27 phase skills + 8 foundation skills + 6 utility skills) plus templates and workflows for consistent, professional PM outputs.</h4>
...
<p align="center">
  ...
  <a href="#the-skills">
    <img src="https://img.shields.io/badge/skills-41-brightgreen.svg?style=flat-square" alt="Skills">
  </a>
...
- ✅ **41 Production-Ready Skills** covering the complete product lifecycle (27 phase skills + 8 foundation skills + 6 utility skills)
...
The file-based install ships all 41 production-ready PM skills (27 phase skills + 8 foundation skills + 6 utility skills). The frozen v2.9.2 MCP build embeds the 40-skill catalog from the time of its publication, after which point only the file-based install receives new skills.
...
**Fastest path:** Install all 41 skills into your agent with one command, using the open [`skills` CLI](https://github.com/vercel-labs/skills):
...
After install, all 41 skills and 48 commands resolve from any directory. Slash commands like `/prd`, `/opportunity-tree`, `/agenda`, `/okr-writer`, etc. work out of the box.
...
Installs all 41 skills into your agent's default skills directory. Slash commands (`/prd`, `/hypothesis`, `/user-stories`, etc.) become available immediately. No clone, no sync helper.
...
All 41 skills are available as `/skill-name` commands. See [commands/](commands/) for the full list.
...
Open the folder in Cursor or Windsurf. The AI assistant will automatically discover and can use all 41 skills.
...
This clones pm-skills, scans the `skills/` directory, and installs all 41 skills into your agent's default skills directory. Supported agents include Claude Code, Cursor, GitHub Copilot, Cline, and others. Discoverable via the [skills.sh directory](https://skills.sh/product-on-purpose/pm-skills).
...
```
pm-skills/
├── skills/                     # 41 PM skills (27 phase + 8 foundation + 6 utility)
├── commands/                   # Slash commands (48) mapping to skills/workflows
...
<details>
<summary><strong>Do I need to install all 41 skills?</strong></summary>
...
**pm-skills** (this repo) is the source skill library with all 41 PM skills as markdown files. It's best for Claude Code slash commands, file browsing, and customization.
