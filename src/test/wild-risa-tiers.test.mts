...
// Audience-tier text added 2026-05-03 to wild-risa-balance + proceed-with-the-recommendation
// (source skill + plugin mirror, four files total). Each literal here defends a normative
// behavior — dropping any of them silently downgrades the tier contract back to a flat
// expert-only block, which is the exact failure mode the floor lint was created to prevent.
...
const WILD_RISA_LITERALS: ReadonlyArray<LiteralCheck> = [
  {
