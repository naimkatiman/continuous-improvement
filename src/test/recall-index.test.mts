...
function obs(partial: Partial<RecallObservation>): RecallObservation {
...
describe("formatRecallHits", () => {
  ...
  it("renders ranked hits with scores", () => {
    const out = formatRecallHits(
      [{ ts: "2026-05-20T10:00:00Z", session: "s1", tool: "Bash", snippet: "permission denied", score: 1.23, index: 0 }],
      "permission",
    );
