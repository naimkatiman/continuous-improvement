...
import type { PackageJson } from "../lib/cli-anything.mjs";
...
describe("CLI-Anything", () => {
  ...
  test("should categorize scripts correctly", () => {
    const testCases: Array<{ expected: string; name: string }> = [
  ...
  test("should detect project types", () => {
    const testCases: Array<{ expected: string; packageJson: PackageJson }> = [
